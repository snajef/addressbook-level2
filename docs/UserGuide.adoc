...
Sort the Address Book by a given sorting key. +
Format: `sort [name|email|address]`

****
Sorts the Address Book by a given sorting key, and returns a view of the Address Book.
****

Examples:

* `sort name`
Sorts the Address Book by name in lexicographical order, and views the Address Book.

* `sort email`
Sorts the Address Book by email address in lexicographical order, and views the Address Book.
